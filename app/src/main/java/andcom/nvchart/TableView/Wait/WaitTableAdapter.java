...
public class WaitTableAdapter extends AbstractTableAdapter<ColumnHeaderModel,RowHeaderModel,CellModel> {
    Context context;
    ...
    public AbstractViewHolder onCreateColumnHeaderViewHolder(ViewGroup parent, int viewType) {
        ...
        return new WaitColumnHeaderViewHolder(layout,getTableView());
    }
    ...
    public void onBindColumnHeaderViewHolder(AbstractViewHolder holder, Object columnHeaderItemModel, int
        ...
        // Get the holder to update cell item text
        WaitColumnHeaderViewHolder columnHeaderViewHolder = (WaitColumnHeaderViewHolder) holder;
