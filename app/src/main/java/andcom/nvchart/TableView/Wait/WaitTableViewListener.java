...
public class WaitTableViewListener implements ITableViewListener {
    private static final String LOG_TAG = WaitTableViewListener.class.getSimpleName();

    private ITableView mTableView;
    private TableView tableView;

    public WaitTableViewListener(ITableView pTableView) {
